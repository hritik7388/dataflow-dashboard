...
<div className="min-w-[900px]">
  {products
    ...
    .map((p, i) => (
      <div
        key={i}
        className={`grid grid-cols-[2.8fr_1.5fr_1fr_1fr_0.8fr_1.2fr_1.5fr_1fr] px-4 py-4 items-center rounded-xl text-sm text-gray-700 ${
      ...
      >
       ...
       <div>
  {p.stock === "in" ? (
    <span className="bg-green-100 text-green-600 px-2 py-1 rounded-md text-[10px] md:text-xs font-medium whitespace-nowrap">
      Complete
    </span>
  ) : p.stock === "new" ? (
    <span className="bg-red-100 text-red-500 px-2 py-1 rounded-md text-[10px] md:text-xs font-medium whitespace-nowrap">
      New
    </span>
  ) : (
    <span className="bg-yellow-100 text-yellow-600 px-2 py-1 rounded-md text-[10px] md:text-xs font-medium whitespace-nowrap">
      Pending
    </span>
  )}
</div>
        ...
        {/* Start Date */}
        <div className="text-orange-500 text-xs md:text-sm whitespace-nowrap">
          Tracking
        </div>
