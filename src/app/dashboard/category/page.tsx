...
export default function CategoryPage() {
    const products = [
        { name: "Neptune Long-sleeve", qty: "1,638", sale: "20", },
        { name: "Neptune Long-sleeve", qty: "1,638", sale: "20", },
        { name: "Neptune Long-sleeve", qty: "1,638", sale: "20", },
        { name: "Neptune Long-sleeve", qty: "1,638", sale: "20", },
        { name: "Neptune Long-sleeve", qty: "1,638", sale: "20", },
        ...
        <div className="p-2 md:p-4 lg:p-6 bg-[#f5f6fa] min-h-screen">
            ...
            <div className="bg-white rounded-2xl p-4 md:p-5 shadow-sm">
                ...
                <div className="overflow-x-auto ">
                    ...
                    {/* HEADER */}
                    <div className="min-w-[900px] grid grid-cols-[3fr_2fr_1fr_1.5fr_1fr] px-4 py-3 text-[12px] text-gray-900 font-semibold uppercase bg-[#f8f9fb] rounded-xl">
                        <div>Category</div>
                        <div>Quantity</div>
                        <div>Sale</div>
                        <div>Start date</div>
                    ...
                    <div className="min-w-[900px]">
                        {products
                            ...
                            .map((p, i) => (
                                <div
                                    key={i}
                                    className={`grid grid-cols-[3fr_2fr_1fr_1.5fr_1fr] px-4 py-4 items-center rounded-xl text-sm text-gray-700 ${i % 2 === 0 ? "bg-white" : "bg-[#f8f9fb]"
                                        } hover:bg-orange-50`}
                                >
